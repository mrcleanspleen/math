...
def solve_inequality2():
    ...
    print(c.base03 + a + "x + " + c.red + "?" + c.base03 + "y " + in1 + " ?")
    b1 = input(">>> ")
    print(c.clear + "Enter C value then hit enter")
    print(c.base03 + a + "x + " + b + "y " + in1 + c.red + " ?" + c.x)
    d1 = input(">>> ")
    ...
    a2 = input(">>> ")
    print(c.clear + "Enter B value then hit enter")
    print(c.base03 + a + "x + " + c.red + "?" + c.base03 + "y " + in2 + " ?")
    b2 = input(">>> ")
    print(c.clear + "Enter C value then hit enter")
    print(c.base03 + a + "x + " + b + "y " + in2 + c.red + " ?" + c.x)
    d2 = input(">>> ")
