...
def solve_inequality2():
    ...
    print(c.cl + c.x +  """Welcome to the system of inequalities solver machine")
    Make sure you have 2 inequalities")
    "Make sure the equation is in standard form, or Ax + By = C")
    "Make sure your have no fractions or decimals")
    Enter the first equations ineqaulity. Use only""" + c.magenta +" >, <, <=, or >=.")
    print(c.x + "?x + ?y " + c.red + "_ " + c.x + "?")
    in1 = input(">>> ")
    print(c.cl + "Enter A value then hit enter")
    print(c.red + "?" + c.x + "x + ?y " + in1 + " ?")
    a1 = input(">>> ")
    print(c.clear + "Enter B value then hit enter")
    print(c.x + a1 + "x + " + c.red + "?" + c.x + "y " + in1 + " ?")
    b1 = input(">>> ")
    print(c.clear + "Enter C value then hit enter")
    print(c.x + a1 + "x + " + b1 + "y " + in1 + c.red + " ?" + c.x)
    d1 = input(">>> ")
    print(c.cl + "Enter the second equations ineqaulity. Use only >, <, <=, or >=.")
    print(c.x + "?x + ?y " + c.red + "_ " + c.x + "?")
    in2 = input(">>> ")
    print(c.cl + "Enter A value then hit enter")
    print(c.red + "?" + c.x + "x + ?y " + in2 + " ?")
    a2 = input(">>> ")
    print(c.clear + "Enter B value then hit enter")
    print(c.x + a2 + "x + " + c.red + "?" + c.x + "y " + in2 + " ?")
    b2 = input(">>> ")
    print(c.clear + "Enter C value then hit enter")
    print(c.x + a2 + "x + " + b2 + "y " + in2 + c.red + " ?" + c.x)
    d2 = input(">>> ")
